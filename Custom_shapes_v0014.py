...
# import Custom_shapes_v0014
# import imp
# imp.reload(Custom_shapes_v0014)
# Custom_shapes_v0014.GUI()
# and Run! (Maya 2023 and previous versions supported)
######################################################################
...
def GUI():
	...
	#create new window
	Win = cmds.window('custom_shape_changer_UI', wh=(245,180), sizeable= False , mnb=1, mxb=0)
	#mainLayout
	...
	cmds.scrollField( text = helpText, w=233, h=150, editable = False, wordWrap = True )
	# run the window
	cmds.showWindow(Win)
